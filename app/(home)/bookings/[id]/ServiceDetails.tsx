...
const ServiceDetails: React.FC<{ services: IService[] }> = ({ services }) => (
    <div className="border rounded-md border-[#E4E7EC] overflow-y-auto  p-5 flex flex-col gap-x-2 gap-y-5">
        <p className="text-xl">Service Details</p>
        <div className="overflow-y-scroll max-h-[500px] custom-scrollbar">
