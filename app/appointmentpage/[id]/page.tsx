...
<div className="flex justify-between mt-9 ">
      ...
      <input placeholder="Search" className="border rounded-lg px-12 py-2 mx-4 bg-gray-200" />
          {/* <IoIosSearch />Search */}
          ...
          <tbody>
            ...
            {appointments.map((item) => (
              ...
              >
                ...
                <td className="py-2 bg-blue-200 text-gray-600 font-medium flex justify-center">{item.tag}</td>
